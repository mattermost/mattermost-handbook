...
The Support Team is driven by three key metrics, First Reply Time, Next Reply Time and Customer Satisfaction.  Deatils of these metrics for our enterprise customers can be found [here](https://handbook.mattermost.com/operations/business-operations/analytics/metrics-definitions#support-tickets).
