...
| installation | Refers to an on-premises Mattermost environment comprising hardware (server/s), database, and filestore, etc which hosts the required files to run Mattermost. | <ul><li> Your Mattermost installation includes physical servers </li></ul> |
