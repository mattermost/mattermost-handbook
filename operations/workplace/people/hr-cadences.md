...
When opinions are asked for, and listened to, people feel aligned with the issue and accept ownership of the solution. Even when a suggested solution is not the chosen solution, sharing context on the decision will help describe the complexity of an issue or highlight potential blindspots. 
