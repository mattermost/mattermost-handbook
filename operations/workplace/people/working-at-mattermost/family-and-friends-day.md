...
We announced this program at [COM](https://handbook.mattermost.com/operations/operations/company-cadence#customer-obsession-meeting-aka-com), and will run the majority of the company with the minimal staff needed to meet our service level commitments - and we’d ask the staff who are on-call, or who choose to work that day, to take an alternate day off.
...
We can assume most team members will be off these days, but still recommend updating your ‘out of office’ messages in Mattermost and email and reference the public announcement to Family and Friends Days, and that you’ll return messages after the event.
