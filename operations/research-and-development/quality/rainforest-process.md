...
8. Scroll down so that **Platform** is visible and check that the correct platform to test on is selected (for mobile runs, you can click on **Mobile VM** to display only the mobile options).
    ...
    ![alt_text](images/rainforest_image8.png "image_tooltip")
...
1. From this page: [https://app.rainforestqa.com/runs?page=1&mode=standard](https://app.rainforestqa.com/runs?page=1&mode=standard), click on the run group you want to review. For this example, we’ll use the **Android - Account Settings**.
    ...
    ![alt_text](images/rainforest_image9.png "image_tooltip")

2. You’ll be taken to this screen:

    ![alt_text](images/rainforest_image10.png "image_tooltip")

3. Notice that 2 tests failed. Click on the first test that failed. You’ll be taken to this screen:

    ![alt_text](images/rainforest_image11.png "image_tooltip")
...
4. Scroll down until you see a red **X** to the right of the step that failed, then click on the **X**.
    ...
    **Note**: Sometimes one crowd tester will get further along in a test than another tester, so there may be more than one point of failure, as there is in this example. In cases like this, click on both **X**’s to see what failed.
    ...
    ![alt_text](images/rainforest_image12.png "image_tooltip")

    a. Let’s look at the failure in the first red X.

    ![alt_text](images/rainforest_image13.png "image_tooltip")
    ...
    ![alt_text](images/rainforest_image14.png "image_tooltip")
...
5. When it starts to look like testers are confused, open the test and preview it to ensure instructions are clear and test steps are correct. To do this, click on **Open Test** at the top of the screen.
    ...
    ![alt_text](images/rainforest_image15.png "image_tooltip")
    ...
    ![alt_text](images/rainforest_image16.png "image_tooltip")
    ...
    ![alt_text](images/rainforest_image17.png "image_tooltip")
    ...
    ![alt_text](images/rainforest_image19.png "image_tooltip")

    e. Once you have previewed the test (and made any updates to the test itself), go back to the failed test in the run group. For this example, it’s this page: [https://app.rainforestqa.com/runs/880602/tests/237283/browsers/android_phone_12/steps/103213942](https://app.rainforestqa.com/runs/880602/tests/237283/browsers/android_phone_12/steps/103213942). As these examples have already been reviewed and categorized, you can see that I refactored this test for clarity but, if you were reviewing the test on failure, you’d:

        i.  Click on the **Categorize Failure** button, top right of the screen.
  
           ![alt_text](images/rainforest_image20.png "image_tooltip")

        ii. Select **Needs Refactor**, then click on the blue **Next** button (the option to refactor the test yourself is already checked).

           ![alt_text](images/rainforest_image21.png "image_tooltip")

        iii. Type in your comments/reason for refactor, then click the blue **Save** button.

           ![alt_text](images/rainforest_image22.png "image_tooltip")

        iv. Once you’ve clicked **Save**, you will see that the **Categorize Failure** button has changed to **Categorized: Needs Refactor**.
          ...
          **Note**: Although the button shows NEEDS REFACTOR, you have already refactored the test. To see tests that have been categorized to Needs Refactor, go to the [Dashboard](https://app.rainforestqa.com/dashboard). Here you can click the radio buttons to the left of the tests that you’ve categorized as Needs Refactor and they will disappear from the screen. 
          ...
          ![alt_text](images/rainforest_image23.png "image_tooltip")

          ![alt_text](images/rainforest_image24.png "image_tooltip")
     ...
     v.   To review the next failure in a run group, you can click on the **Next Failure** or **Previous Failure** buttons at the bottom of the screen. Once all failures have been reviewed, these buttons are both grayed out.

          ![alt_text](images/rainforest_image25.png "image_tooltip")
...
4. At first glance, this seemed to be a bug as Team Open was not in view. However, when reviewing previous steps in the automated test run, I couldn’t work out why the test had failed. Sometimes it’s difficult to see exactly what was clicked on in the automated replay. In this instance, I opened the test and ran a preview. To do this, click on the **Open Test** option, top right of the screen.
    ...
    ![alt_text](images/rainforest_image29.png "image_tooltip")
...
5. You’ll be taken to the test preview page. Once the VM has loaded on the right-hand-side, click the **Select All** button, top left of the screen then manually deselect the first 2 steps as these are to load the VM to the starting page.
    ...
    ![alt_text](images/rainforest_image30.png "image_tooltip")
...
![alt_text](images/rainforest_image31.png "image_tooltip")

MATTERMOST

![alt_text](images/rainforest_image32.png "image_tooltip")

ZEPHYR

![alt_text](images/rainforest_image33.png "image_tooltip")
...
1. The test in Rainforest (RF-B577 MM-T4173 - Boards Plugin - (Mac/Catalina) - Empty Board - Groups) failed due to browser rendering issues since Rainforest updated the browsers on their VMs so, after updating the screenshot, the test can be categorized as “System Issues” as per screenshot below:
    ...
    ![alt_text](images/rainforest_image34.png "image_tooltip")
