...
| **Medium**       | **A frustrating friction point or an issue so “cringey” it erodes trust.**               | Documentation gaps, misleading error text or guidance, complex UX, inconsistent user interactions, functional regressions   | Fixed within 60 days       | Fix can be committed after T-19 Code Complete       |
| **Low**          | **An inconsistency that affects polish.**                                                | UI misalignment, unclear labels, minor documentation errors, cosmetic regressions                                           | Fixed within 90 days       | Fix can only be committed before T-19 Code Complete |


## Assigning priority levels

Priority levels on Jira tickets should be filled in by the ticket reporter using the **Priority** field. If the field is left blank, the triage team will assign Priority based on the guidelines above. 
