...
2. Release Manager:
    ...
    - If there are any breaking compatibility changes in an ESR release, open an issue in the [GitLab Omnibus](https://gitlab.com/gitlab-org/omnibus-gitlab) to make sure GitLab is aware
